...
f_b_real = li.calc_f_b_real(f_b,w_b)
fe = li.calc_fe(f_b,w_b,q[i])
a_e = li.calc_a_e(f_b,w_b,q[i])
a_e_real = li.calc_a_e_real(f_b,w_b,q[i],r[i],v[i])
v[i+1] = li.calc_v_e(f_b,w_b,q[i],r[i],v[i])
r[i+1] = li.calc_r_e(v_i=v[i+1])
